...
public class BuildingHand_Panel : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            IngameBuildingManager.Instance.OnBuildingHandChanged += UpdateHandUI;
            UpdateHandUI(IngameBuildingManager.Instance.BuildingHand);
        }
    }
